import{c as r,g as s,a as v,b as $,f as d,d as h,e as g,v as j,h as k,i as I}from"./dom-utils-45v2EbIQ.js";/* empty css                */import{o as b}from"./orders-DM04ZAuh.js";function m(){const t=`
 ...
 `;s(".js-header-content").innerHTML=t}function l(){let t=0,i=0;r.cartItems.forEach(n=>{const p=v(n.productId);if(!p)return;t+=p.priceCents*n.quantity;const f=$(n.deliveryOptionId);i+=f.priceCents});const a=t+i,e=a*.1,o=a+e,c=`
  ...
  `}),s(".js-order-summary").innerHTML=t}function E(t,i){let a="";return g.forEach(e=>{const o=h(e),c=e.priceCents===0?"FREE":`$${d(e.priceCents)} -`,n=e.id===i.deliveryOptionId;a+=`
